 ...
 * @since AM 5.5.0
 */
public class YotiNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(YotiNodePlugin.currentVersion,
                                        Arrays.asList(YotiStaticScenarioNode.class, YotiDynamicScenarioNode.class));
    }
    ...
    public String getPluginVersion() {
        return YotiNodePlugin.currentVersion;
    }
